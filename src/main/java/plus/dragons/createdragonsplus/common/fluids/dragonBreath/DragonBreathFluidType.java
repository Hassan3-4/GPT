...
public final class DragonBreathFluidType extends SolidRenderFluidType {
    ...
    private DragonBreathFluidType(Properties properties, Identifier stillTexture, Identifier flowingTexture, int tintColor, Vector3f fogColor, Supplier<Float> fogDistanceModifier, Supplier<Block> cauldron) {
