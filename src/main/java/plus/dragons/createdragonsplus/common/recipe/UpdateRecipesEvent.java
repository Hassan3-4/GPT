...
public class UpdateRecipesEvent extends Event {
    ...
    private final Map<Identifier, RecipeHolder<?>> byName;
    private int added;
    private int removed;

    @Internal
    public UpdateRecipesEvent(RecipeManager recipeManager, Multimap<RecipeType<?>, RecipeHolder<?>> byType, Map<Identifier, RecipeHolder<?>> byName) {
