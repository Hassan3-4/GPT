...
import com.zurrtum.create.foundation.advancement.AllTriggers;
...
public abstract class CDPAdvancement {
     ...
     * You can check {@link AllTriggers#register()} and {@link com.zurrtum.create.Create#onRegister(RegisterEvent)}. <br>
     * 
     * @return A BuiltinTrigger
     */
    protected abstract BuiltinTrigger add(Identifier id);
    ...
    private Identifier asResource(String id) {
