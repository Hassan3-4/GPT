...
import com.zurrtum.create.foundation.mixin.accessor.MappedRegistryAccessor;
...
public final class IntegrationResultRecipe implements Recipe<RecipeInput> {
    ...
    public IntegrationResultRecipe(Recipe<?> delegate, ItemStack delegateResult, Identifier result) {
    ...
    public static class Builder extends BaseRecipeBuilder<IntegrationResultRecipe, Builder> {
        ...
        public Builder(BaseRecipeBuilder<?, ?> delegate, ItemStack delegateResult, Identifier result) {
