...
import static com.zurrtum.create.AllBlocks.ITEM_DRAIN;
...
public class CDPRecipeProvider extends RegistrateRecipeProvider {
    ...
    private void buildFreezingRecipes(RecipeOutput output) {
        Function<Identifier, StandardProcessingRecipe.Builder<FreezingRecipe>> freezing = FreezingRecipe::builder;
    ...
    private void buildEndingRecipes(RecipeOutput output) {
        Function<Identifier, StandardProcessingRecipe.Builder<EndingRecipe>> ending = EndingRecipe::builder;
