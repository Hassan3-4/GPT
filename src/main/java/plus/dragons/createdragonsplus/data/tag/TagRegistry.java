...
public class TagRegistry<T, P extends RegistrateTagsProvider<T>> {
    ...
    public final TagKey<T> tag(String path) {
        return TagKey.create(this.registry, Identifier.fromNamespaceAndPath(this.namespace, path));
    }
    ...
    public final void addOptional(TagKey<T> tag, Identifier value) {
    ...
    public final void addOptionalTag(TagKey<T> tag, Identifier value) {
    ...
    protected class ProviderEntry {
        ...
        protected final List<Identifier> optionalValues = new ArrayList<>();
        protected final List<TagKey<T>> tagValues = new ArrayList<>();
        protected final List<Identifier> optionalTagValues = new ArrayList<>();
