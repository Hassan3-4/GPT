...
public class StressConfig extends ConfigBase {
    ...
    protected final Object2DoubleMap<Identifier> defaultImpacts = new Object2DoubleOpenHashMap<>();
    protected final Object2DoubleMap<Identifier> defaultCapacities = new Object2DoubleOpenHashMap<>();
    ...
    public <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> setImpact(double value) {
        return builder -> {
            ...
            Identifier id = Identifier.fromNamespaceAndPath(modid, builder.getName());
