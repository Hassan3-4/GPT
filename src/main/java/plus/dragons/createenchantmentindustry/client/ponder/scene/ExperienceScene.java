...
public class ExperienceScene {
    public static void basic(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(3, 2, 4), BrassTunnelBlockEntity.class, be -> {
            var filtering = be.getBehaviour(ServerSidedFilteringBehaviour.TYPE);
            if (filtering != null) {
                filtering.setFilter(Direction.EAST, new ItemStack(AllItems.EXP_NUGGET));
            }
        });
        scene.idle(5);
        scene.world().createItemOnBelt(util.grid().at(3, 1, 11), Direction.UP, new ItemStack(AllItems.EXP_NUGGET));
        scene.idle(20);
        scene.world().createItemOnBelt(util.grid().at(3, 1, 11), Direction.UP, new ItemStack(AllItems.EXP_NUGGET));
        scene.idle(20);
        scene.world().createItemOnBelt(util.grid().at(3, 1, 11), Direction.UP, new ItemStack(AllItems.EXP_NUGGET));
        ...
        ElementLink<EntityElement> itemEntity2 = scene.world().createItemEntity(util.vector().blockSurface(util.grid().at(3, 2, 10), Direction.DOWN, 0), util.vector().of(0, 0, 0), new ItemStack(AllItems.EXP_NUGGET));
        scene.idle(13);
        ...
        scene.world().createItemOnBelt(util.grid().at(3, 1, 10), Direction.DOWN, new ItemStack(AllItems.EXP_NUGGET));
        scene.idle(10);
        ...
        scene.world().modifyBlockEntityNBT(deployer, DeployerBlockEntity.class, nbt -> {
            nbt.store("HeldItem", ItemStack.OPTIONAL_CODEC,
                    scene.world().getHolderLookupProvider().createSerializationContext(net.minecraft.nbt.NbtOps.INSTANCE), sword);
        ...
        scene.world().createItemOnBelt(deployerPos.west().below(), Direction.SOUTH, new ItemStack(AllItems.EXP_NUGGET));
        scene.idle(20);
    ...
    public static void prepare(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        scene.world().setBlock(util.grid().at(1, 1, 1), AllBlocks.DEPOT.defaultBlockState(), false);
        scene.world().showSection(util.select().position(1, 1, 1), Direction.DOWN);
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 1), DepotBlockEntity.class, be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(CEIItems.EXPERIENCE_CAKE.asStack())));
        scene.idle(10);
        scene.overlay().showText(60)
        ...
        scene.overlay().showText(80)
                ...
                .pointAt(util.vector().topOf(1, 1, 1));
        scene.idle(65);
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 1), DepotBlockEntity.class, be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(CEIItems.SUPER_ENCHANTING_TEMPLATE.asStack())));
        scene.idle(25);
        scene.overlay().showText(45)
