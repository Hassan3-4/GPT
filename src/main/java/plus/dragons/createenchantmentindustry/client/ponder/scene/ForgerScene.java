...
public class ForgerScene {
    public static void basic(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 3), FluidTankBlockEntity.class, be -> {
            ...
            if (ctrl != null) ctrl.getTankInventory().insert(new FluidStack(CEIFluids.EXPERIENCE, 8000));
        });
        scene.idle(20);
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 3), FluidTankBlockEntity.class, be -> {
            var ctrl = be.getControllerBE();
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 2, 1), BlazeForgerBlockEntity.class,
                be -> be.getNormalTank().insert(new FluidStack(CEIFluids.EXPERIENCE, 4000)));
    ...
    public static void superEnchant(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(30);
        scene.world().modifyBlockEntity(util.grid().at(2, 2, 1), BlazeForgerBlockEntity.class,
                be -> be.getSpecialTank().setFluid(new FluidStack(CEIFluids.EXPERIENCE, 4000)));
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 2, 1), BlazeForgerBlockEntity.class,
                be -> {
                    be.getSpecialTank().setFluid(new FluidStack(CEIFluids.EXPERIENCE, 4000));
        ...
        scene.world().setBlock(util.grid().at(2, 2, 1), AllBlocks.LIT_BLAZE_BURNER.defaultBlockState(), false);
        scene.idle(20);
    }
    ...
    public static void automate(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(input, DepotBlockEntity.class,
                depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(Items.DIAMOND_SWORD.getDefaultInstance())));
        ...
        scene.world().modifyBlockEntity(input2, DepotBlockEntity.class,
                depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(template)));
        ...
        scene.idle(20);
        scene.world().modifyBlockEntity(input, DepotBlockEntity.class, depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(ItemStack.EMPTY)));
        ...
        scene.world().instructArm(armPos, ArmBlockEntity.Phase.MOVE_TO_INPUT, ItemStack.EMPTY, 1);
        scene.idle(20);
        scene.world().modifyBlockEntity(input2, DepotBlockEntity.class, depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(ItemStack.EMPTY)));
        ...
        scene.overlay().showText(60)
                ...
                .attachKeyFrame();
        scene.world().modifyBlockEntity(input, DepotBlockEntity.class,
                depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(CEIItems.EXPERIENCE_CAKE.asStack())));
        scene.idle(10);
        scene.world().instructArm(armPos, ArmBlockEntity.Phase.MOVE_TO_INPUT, ItemStack.EMPTY, 0);
        scene.idle(20);
        scene.world().modifyBlockEntity(input, DepotBlockEntity.class, depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(ItemStack.EMPTY)));
        ...
        scene.world().modifyBlockEntity(output, DepotBlockEntity.class, depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(enchanted)));
        scene.idle(20);
    }
}
