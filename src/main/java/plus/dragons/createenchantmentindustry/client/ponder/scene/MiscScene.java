...
public class MiscScene {
    private static ItemStack cdpRareMarbleGatePackage() {
        return net.minecraft.core.registries.BuiltInRegistries.ITEM
                .get(net.minecraft.resources.Identifier.fromNamespaceAndPath("create_dragons_plus", "rare_marble_gate_package"))
    ...
    public static void experienceHatch(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), FluidTankBlockEntity.class, be -> {
            ...
            if (ctrl != null) ctrl.getTankInventory().insert(new FluidStack(CEIFluids.EXPERIENCE, 10000));
        });
        scene.idle(50);

        scene.world().modifyBlockEntity(util.grid().at(3, 2, 1), BasinBlockEntity.class,
                be -> be.inputTank.getPrimaryHandler().insert(new FluidStack(CEIFluids.EXPERIENCE, 1000)));
        scene.idle(10);
        ...
        scene.idle(30);
        scene.world().modifyBlockEntity(util.grid().at(3, 2, 1), BasinBlockEntity.class,
                be -> be.inputTank.getPrimaryHandler().extract(new FluidStack(CEIFluids.EXPERIENCE, 1000)));
        scene.idle(40);
        ...
        for (int i = 0; i < 12; i++) {
            scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), FluidTankBlockEntity.class, be -> {
                var ctrl = be.getControllerBE();
                if (ctrl != null) ctrl.getTankInventory().insert(new FluidStack(CEIFluids.EXPERIENCE, 1000));
            });
            scene.idle(5);
        }
        scene.idle(30);
        ...
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 1), FluidTankBlockEntity.class, be -> {
            var ctrl = be.getControllerBE();
            if (ctrl != null) ctrl.getTankInventory().insert(new FluidStack(CEIDyeFluids.get(DyeColor.CYAN), 36000));
        });
        scene.idle(10);
        scene.overlay().showText(40)
        ...
        for (int i = 0; i < 12; i++) {
            scene.world().modifyBlockEntity(util.grid().at(1, 1, 1), FluidTankBlockEntity.class, be -> {
                var ctrl = be.getControllerBE();
                if (ctrl != null) ctrl.getTankInventory().extract(new FluidStack(CEIDyeFluids.get(DyeColor.CYAN), 3000));
            });
            scene.idle(10);
        }
    }
    ...
    public static void printer(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), PrinterBlockEntity.class,
                be -> be.getFluidHandler(null).insert(new FluidStack(CEIDyeFluids.get(DyeColor.BLACK), 3000)));
        scene.idle(40);
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 2), DepotBlockEntity.class,
                be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(new ItemStack(Items.BOOK))));
        scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), PrinterBlockEntity.class,
                be -> be.processingTicks = 50);
        scene.idle(45);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 2), DepotBlockEntity.class,
                be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(Items.WRITTEN_BOOK.getDefaultInstance())));
        scene.idle(50);
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), PrinterBlockEntity.class, be -> {
            var printer = be.getBehaviour(PrinterBehaviour.TYPE);
            var packageItem = cdpRareMarbleGatePackage();
            printer.setFilter(packageItem);
        });
        scene.idle(10);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 2), DepotBlockEntity.class,
                be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(new ItemStack(PackageStyles.ALL_BOXES.get(1)))));
        scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), PrinterBlockEntity.class,
                be -> be.processingTicks = 50);
        scene.idle(45);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 2), DepotBlockEntity.class,
                be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(cdpRareMarbleGatePackage())));
        scene.idle(50);
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 3, 2), PrinterBlockEntity.class, be -> {
            be.getFluidHandler(null).extractAny(3000);
            be.getFluidHandler(null).insert(new FluidStack(CEIFluids.EXPERIENCE, 3000));
        });
        scene.idle(10);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 2), DepotBlockEntity.class,
                be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(new ItemStack(Items.BOOK))));
        ...
        scene.idle(45);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 2), DepotBlockEntity.class,
                be -> be.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(Items.ENCHANTED_BOOK.getDefaultInstance())));
        scene.idle(50);
    ...
    public static void experienceLantern(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 3), FluidTankBlockEntity.class, be -> {
            var ctrl = be.getControllerBE();
            if (ctrl != null) ctrl.getTankInventory().insert(new FluidStack(CEIFluids.EXPERIENCE, 2000));
        });
        scene.idle(40);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 3), FluidTankBlockEntity.class, be -> {
            var ctrl = be.getControllerBE();
