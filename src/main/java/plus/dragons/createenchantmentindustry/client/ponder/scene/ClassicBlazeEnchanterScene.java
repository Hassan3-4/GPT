...
public class ClassicBlazeEnchanterScene {
    public static void basic(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 2), FluidTankBlockEntity.class,
                be -> be.getControllerBE().getTankInventory().insert(new FluidStack(CEIFluids.EXPERIENCE, 64000)));
    ...
    public static void automate(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(20);
        scene.world().modifyBlockEntity(inputPos, DepotBlockEntity.class, depot -> depot.setHeldItem(new com.zurrtum.create.content.kinetics.belt.transport.TransportedItemStack(ItemStack.EMPTY)));
