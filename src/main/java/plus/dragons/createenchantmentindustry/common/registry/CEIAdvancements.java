...
import plus.dragons.createenchantmentindustry.common.advancements.StatTrigger;
import plus.dragons.createenchantmentindustry.util.CEIAdvancement;

public class CEIAdvancements implements DataProvider {
    public static final StatTrigger STAT_TRIGGER = new StatTrigger();
    ...
    public static final CEIAdvancement START = null,
            ...
            ROOT = create("root", b -> b.icon(CEIItems.EXPERIENCE_BUCKET)
                    ...
                    .awardedForFree()
                    .special(CEIAdvancement.TaskType.SILENT)),
            ...
            A_SHOWER_EXPERIENCE = create("a_shower_experience", b -> b.icon(AllItems.EXP_NUGGET)
                    ...
                    .special(CEIAdvancement.TaskType.SECRET)
            ...
            GRIND_TO_POLISH = create("grind_to_polish", b -> b.icon(AllItems.SAND_PAPER)
                    ...
                    .special(CEIAdvancement.TaskType.NOISY)
            ...
            EXPERIENCED_RECYCLER = create("experienced_recycler", b -> b.icon(CEIBlocks.GRINDSTONE_DRAIN)
                    ...
                    .special(CEIAdvancement.TaskType.EXPERT)
            ...
            LEGACY_IGNITION = create("legacy_ignition", b -> b.icon(CEIBlocks.CLASSIC_BLAZE_ENCHANTER)
                    ...
                    .whenIconCollected()
                    .loadWhen(CEIResourceConditions.CLASSIC_BLAZE_ENCHANTER_ENABLED)
                    .after(BLAZE_ENCHANTERY)),
            ...
            ASSEMBLY_AESTHETICS = create("assembly_aesthetics", b -> b.icon(registries -> new net.minecraft.world.item.ItemStack(
                    BuiltInRegistries.ITEM.getOptional(Identifier.fromNamespaceAndPath("create_dragons_plus", "rare_marble_gate_package"))
                            .orElse(PackageStyles.getDefaultBox().getItem())))
    ...
    private static CEIAdvancement create(String id, UnaryOperator<CEIAdvancement.Builder> b) {
        ...
        return this.registries.thenCompose(provider -> {
            ...
            Consumer<AdvancementHolder> consumer = (advancement) -> {
                ...
                JsonObject json = Advancement.CODEC
                        ...
                        .getAsJsonObject();
                CEIAdvancement definition = ENTRIES.stream()
                        .filter(entry -> CEICommon.asResource(entry.id()).equals(advancement.id()))
                        .findFirst()
                        .orElseThrow();
                FabricDataGenHelper.addConditions(json, definition.loadConditions());
    ...
    public static void register() {
        Registry.register(BuiltInRegistries.TRIGGER_TYPES, CEICommon.asResource("stat"), STAT_TRIGGER);
    }
    ...
    public static class BuiltinTriggersQuickDeploy {
        private static final Map<Identifier, BuiltinTrigger> triggers = new IdentityHashMap<>();

        public static BuiltinTrigger add(Identifier id) {
