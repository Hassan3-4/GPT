...
public class AddressPrintingBehaviour implements PrintingBehaviour {
    ...
    public int getRequiredFluidAmount(Level level, ItemStack stack, FluidStack fluidStack) {
        var amount = CEIDataMaps.PRINTING_ADDRESS_INGREDIENT.get(fluidStack.getRegistryEntry());
    ...
    public boolean addToGoggleTooltip(List<Component> tooltip, boolean isPlayerSneaking) {
        ...
        var amount = CEIDataMaps.PRINTING_ADDRESS_INGREDIENT.get(tank.getPrimaryHandler().getFluid().getRegistryEntry());
        if (amount != null)
