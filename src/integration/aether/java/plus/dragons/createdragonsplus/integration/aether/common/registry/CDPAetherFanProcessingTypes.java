...
public class CDPAetherFanProcessingTypes {
    ...
    public static final DeferredHolder<FanProcessingType, AetherEnchantingFanProcessingType> ENCHANTING = TYPES
            .register("aether_enchanting", AetherEnchantingFanProcessingType::new);
